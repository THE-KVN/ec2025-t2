...
namespace NETCoreBot.Strategy
{
    public static class Elephant
    {
        ...
        public static bool IsPathStillValid(List<ElephantNode>? path, Animal myAnimal, List<Cell> allCells)
        {
        ...
        public static (Cell? bestPellet, List<ElephantNode>? bestPath) FindBestMultiPelletPath(
            Animal myAnimal,
            Dictionary<(int, int), CellContent> grid)
        {
    ...
    int maxPelletsToChain)
        ...
        public static List<ElephantNode>? ValidateOrComputePath(Animal myAnimal, Cell target, Dictionary<(int, int), CellContent> grid)
        {
        ...
        public static List<ElephantNode>? FindPathOpponent(
            int startX,
            int startY,
            int targetX,
            int targetY,
        ...
        public static IEnumerable<ElephantNode> GetNeighborsPortalOpponent(
                ElephantNode current,
                Dictionary<(int, int), CellContent> grid,
                int targetX,
                int targetY,
        ...
        public static BotAction? ComputeNextMoveRateLimited(Animal myAnimal, List<ElephantNode> path)
        {
            if (path.Count == 0)
            {
        ...
        private static int CountPelletsOnPath(List<ElephantNode> path, Dictionary<(int, int), CellContent> grid)
        {
            int count = 0;
            foreach (var node in path)
            {
        ...
        public static void LogCurrentPath(List<ElephantNode> path)
        {

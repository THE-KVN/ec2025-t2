...
namespace NETCoreBot.Strategy
{
    public static class Gorilla
    {
        ...
        //additional
        public static int ENEMY_PATH_AVOIDANCE = 30;
        ...
        public static bool IsPathStillValid(List<GorillaNode>? path, Animal myAnimal, List<Cell> allCells, GameState state)
        {
        ...
        public static List<GorillaNode>? ValidateOrComputePath(Animal myAnimal, Cell target, Dictionary<(int, int), CellContent> grid, GameState state)
        {
        ...
        public static void LogCurrentPath(List<GorillaNode> path)
        {
            var coords = path.Select(n => $"({n.X},{n.Y})");
            Console.WriteLine("Current path: " + string.Join(" -> ", coords));
        }

        public static BotAction? ComputeNextMoveRateLimited(Animal myAnimal, List<GorillaNode> path)
        {
        ...
        public static List<GorillaNode>? FindPath(
            int startX,
            int startY,
            int targetX,
            int targetY,
        ...
        public static List<GorillaNode>? FindPathEscape(
            int startX,
            int startY,
            int targetX,
            int targetY,
        ...
        public static List<GorillaNode>? FindPathOpponent(
            int startX,
            int startY,
            int targetX,
            int targetY,
        ...
        public static IEnumerable<GorillaNode> GetNeighborsPortal(
            GorillaNode current,
            Dictionary<(int, int), CellContent> grid,
            int targetX,
            int targetY,
        ...
        public static IEnumerable<GorillaNode> GetNeighborsPortalEscape(
            GorillaNode current,
            Dictionary<(int, int), CellContent> grid,
            int targetX,
            int targetY,
        ...
        public static IEnumerable<GorillaNode> GetNeighborsPortalOpponent(
                GorillaNode current,
                Dictionary<(int, int), CellContent> grid,
                int targetX,
                int targetY,
        ...
        public static HashSet<(int, int)> PredictContestedPellets(Animal myAnimal, GameState state)
        {
            ...
            foreach (var animal in state.Animals)
            {
                ...
                //var path = Gorilla.FindPathOpponent(animal.X, animal.Y, pellet.X, pellet.Y, grid, animal, state);
    ...
    public class GorillaNode
    {
        ...
        public GorillaNode(int x, int y, int g, int h, GorillaNode? parent, int tieBreak = 0)
        {
            X = x;
            Y = y;
            G = g;
